...
<main>
    ...
    <div class="container-fluid">
        <div class="row center">
            ...
            <form action="processor.php" method="POST" enctype="multipart/form-data">
                <table id="fileUpload" class="border">
                    ...
                    <tr><td><label for="file">At Home Personal Care File Upload</label></td></tr>
        ...
        <div><?php if(isset($_SESSION['trackingFile'])){ echo "<a href='trackingDownload.php'>Download Tracking File</a>";} ?></div>
        </div>
